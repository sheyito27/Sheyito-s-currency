# Suggestions — pendientes del proyecto

Espejo de los ítems sin marcar de `docs/proposals.md`. Nunca se implementa nada de aquí por
iniciativa propia: se consulta antes de abordar cualquier punto y se espera luz verde explícita.
Al completar e implementar y validar un punto, se marca `[X]` aquí (y también en
`docs/proposals.md`, para que ambas listas sigan sincronizadas).
...
- [X] Renta de chunks: Reclamar con FTB Chunks cuesta 1.000·√n SC (n = chunk que reclamás), pago único, no configurable (sin renta periódica todavía - ver "Día de Renta").
